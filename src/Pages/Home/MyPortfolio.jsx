    ...
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        <div className="portfolio--container">
          <h2 className="port--section--heading">My Portfolio</h2>
          <div className="portfolio--button-container">
            <a href="https://github.com/ge-a/" className="btn btn-github" target="_blank" rel="noopener noreferrer">
              <svg
        ...
        <p className="port--sub--title">Recent Projects</p>
      </div>
